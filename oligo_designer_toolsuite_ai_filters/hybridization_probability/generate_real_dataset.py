...
from oligo_designer_toolsuite.oligo_property_filter import MaskedSequences, PropertyFilter
from oligo_designer_toolsuite.pipelines import BaseOligoDesigner

from .generate_artificial_dataset import split_list
...
def main():
    ...
    oligos_train = [
        oligo_database.database[gene][oligo_id]["sequence"]
